...
func init() {
	...
	flag.StringVar(&flagNew.DateStart, "date_start", date.DateNow(), "Начальная дата запроса. Формат: YYYY-MM-DD")
	flag.StringVar(&flagNew.DateEnd, "date_end", date.DateNow(), "Конечная дата запроса. Формат: YYYY-MM-DD")
